<template>
  ...
  >
    <div class="flex items-stretch overflow-x-auto scrollbar-none px-1 pt-1">
      <router-link
        v-for="item in menu"
        :key="item.path"
        :to="item.path"
        class="flex-none w-[68px] flex flex-col items-center justify-center gap-0.5 py-2 px-1 min-w-0 transition-colors"
...
const allMenu = [
  ...
  { path: '/', label: 'Painel', icon: 'M3 12l9-9 9 9M5 10v10a1 1 0 001 1h3v-6h6v6h3a1 1 0 001-1V10' },
  { path: '/agenda', label: 'Agenda', icon: 'M8 7V3m8 4V3M5 11h14M5 5h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z' },
  { path: '/inbox', label: 'Inbox', icon: 'M4 4h16v12H4V4zm0 8h4l2 3h4l2-3h4M8 8h8' },
  ...
  { path: '/templates', label: 'Modelos', icon: 'M7 3h10a2 2 0 012 2v14l-7-3-7 3V5a2 2 0 012-2zM9 8h6m-6 4h4' },
